...
export default function CategoryShow({ category }: Props) {
  ...
  return (
    <div className='mt-20 mb-10 grid grid-cols-8 gap-10' data-aos='fade-up'>
      <div className='col-span-8 text-center uppercase text-2xl font-medium'>{category.name}</div>
      <div className='col-start-2 col-span-3  rounded-md overflow-hidden'>
      ...
      <div className='col-span-6 col-start-2 border'></div>
    </div>
  )
}
