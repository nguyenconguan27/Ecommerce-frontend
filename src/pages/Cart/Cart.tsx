...
export default function Cart() {
  ...
  const totalCheckedPurchaseSavingPrice = useMemo(
    () =>
      checkedPurchases.reduce((result, current) => {
        return result + (current.product.prePrice - current.product.price) * current.buy_count
      }, 0),
    [checkedPurchases]
  )
  ...
  const handleBuyPurchases = () => {
    if (checkedPurchases.length > 0) {
      ...
      const body = buyPurchases.map((purchase) => ({ product_id: purchase.product.id, buy_count: purchase.buy_count }))
                      ...
                      <div className='col-span-6'>
                        <div className='flex items-center ml-8'>
                          ...
                          <Link
                            ...
                            className='ml-4 flex'
                          >
                            <img src={purchase.product.imageList[0].fileName} alt='' className='object-cover h-20 w-20' />
                      ...
                      <div className='col-span-6'>
                        <div className='grid grid-cols-5'>
                          ...
                          <div className='col-span-1'>
                            <QuantitySelect
                              productQuantity={purchase.product.sizeList[0].quantity}
                              ...
                              increase={(value) =>
                                handleUpdate(
                                  index,
                                  value,
                                  value <= purchase.product.sizeList[0].quantity && purchase.buy_count !== value
                                )
                              }
                              decrease={(value) =>
                              ...
                              onFocusOut={(value) =>
                                handleUpdate(
                                  index,
                                  value,
                                  value <= purchase.product.sizeList[0].quantity &&
                                    value >= 1 &&
