...
export default function QuantitySelect({
  ...
  return (
    <div className={classNameWrapper}>
      <button className='px-2 py-2 border border-gray-300 hover:bg-pink' onClick={handleDecrease}>
        <svg
      ...
      <InputNumber
        ...
        onBlur={handleBlur}
      />
      <button className='px-2 py-2 border border-gray-300 hover:bg-pink' onClick={handleIncrease}>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='none'
          viewBox='0 0 24 24'
